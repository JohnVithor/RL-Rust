...
fn main() {
    ...
    let mut greedy_sarsa_agent = OneStepAgent::new(
    ...
    let mut greedy_qlearning_agent = OneStepAgent::new(
        Box::new(UniformEpsilonGreed::new(
            initial_epsilon,
            Rc::new(move |a| a - epsilon_decay),
            final_epsilon,
    ...
    let mut greedy_expected_sarsa_agent = OneStepAgent::new(
        Box::new(UniformEpsilonGreed::new(
            initial_epsilon,
            Rc::new(move |a| a - epsilon_decay),
            final_epsilon,
    ...
    let agents: Vec<&mut OneStepAgent> = vec![
        &mut greedy_sarsa_agent,
        &mut greedy_qlearning_agent,
        &mut greedy_expected_sarsa_agent,
        &mut ucb_sarsa_agent,
        &mut ucb_qlearning_agent,
        &mut ucb_expected_sarsa_agent,
    ];

    let mut greedy_sarsa_trace_agent: ElegibilityTracesAgent = ElegibilityTracesAgent::new(
        Box::new(UniformEpsilonGreed::new(
            initial_epsilon,
            Rc::new(move |a| a - epsilon_decay),
            final_epsilon,
    ...
    let mut greedy_qlearning_trace_agent: ElegibilityTracesAgent = ElegibilityTracesAgent::new(
        Box::new(UniformEpsilonGreed::new(
            initial_epsilon,
            Rc::new(move |a| a - epsilon_decay),
            final_epsilon,
    ...
    let mut greedy_expected_sarsa_trace_agent: ElegibilityTracesAgent = ElegibilityTracesAgent::new(
        Box::new(UniformEpsilonGreed::new(
            initial_epsilon,
            Rc::new(move |a| a - epsilon_decay),
            final_epsilon,
    ...
    let mut ucb_sarsa_trace_agent: ElegibilityTracesAgent = ElegibilityTracesAgent::new(
        Box::new(UpperConfidenceBound::new(confidence_level)),
        sarsa,
        learning_rate,
        0.0,
    ...
    let mut ucb_qlearning_trace_agent: ElegibilityTracesAgent = ElegibilityTracesAgent::new(
        Box::new(UpperConfidenceBound::new(confidence_level)),
        qlearning,
        learning_rate,
        0.0,
    ...
    let trace_agents: Vec<&mut ElegibilityTracesAgent> = vec![
        &mut greedy_sarsa_trace_agent,
        &mut greedy_qlearning_trace_agent,
        &mut greedy_expected_sarsa_trace_agent,
        &mut ucb_sarsa_trace_agent,
        &mut ucb_qlearning_trace_agent,
        &mut ucb_expected_sarsa_trace_agent,
    ];
    ...
    for (i, agent) in trace_agents.into_iter().enumerate() {
        println!("{} has:", trace_identifiers[i]);
        let mut trainer = DiscreteTrainer::new(
            |repr: usize| -> BlackJackAction {
                match repr {
                    0 => BlackJackAction::HIT,
