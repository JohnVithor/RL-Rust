...
fn main() {
    ...
    let mut one_step_agent_epg: OneStepAgent<usize, CliffWalkingAction> = OneStepAgent::new(
        discount_factor,
        sarsa::<CliffWalkingAction>,
        &mut one_step_policy_epg,
        &mut one_step_epg,
    );
    let mut one_step_agent_ucb: OneStepAgent<usize, CliffWalkingAction> = OneStepAgent::new(
        discount_factor,
        sarsa::<CliffWalkingAction>,
    ...
    let mut trace_agent_epg: ElegibilityTracesAgent<usize, CliffWalkingAction> =
    ...
    let mut trace_agent_ucb: ElegibilityTracesAgent<usize, CliffWalkingAction> =
        ElegibilityTracesAgent::new(
            discount_factor,
            lambda_factor,
            sarsa::<CliffWalkingAction>,
    ...
    let mut agents: Vec<&mut dyn DiscreteAgent<usize, CliffWalkingAction>> = vec![
    ...
    for agent in agents.iter_mut() {
        for func in [
            sarsa::<CliffWalkingAction>,
            qlearning::<CliffWalkingAction>,
            expected_sarsa::<CliffWalkingAction>,
        ] {
